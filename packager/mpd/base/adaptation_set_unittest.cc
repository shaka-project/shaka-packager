...
TEST_F(AdaptationSetTest, AddPreselectionRole) {
  xml::AdaptationSetXmlNode adaptation_set_xml;
  ASSERT_TRUE(adaptation_set_xml.AddPreselectionRole(
...
TEST_F(AdaptationSetTest, AddPreselectionMultipleLabels) {
  xml::AdaptationSetXmlNode adaptation_set_xml;
  ASSERT_TRUE(
      adaptation_set_xml.AddPreselectionLabel("en", "Enhanced Audio"));
  ASSERT_TRUE(
      adaptation_set_xml.AddPreselectionLabel("es", "Audio Mejorado"));
  ASSERT_TRUE(
      adaptation_set_xml.AddPreselectionLabel("fr", "Audio Amélioré"));
