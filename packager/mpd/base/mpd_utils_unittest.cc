...
TEST_F(MpdUtilsTest, ContentProtectionPlayReadyCencMspr) {
  const std::string pssh_str(
      "0000003870737368010000009A04F079"
      "98404286AB92E65BE0885F9500000001"
      "11223344556677889900AABBCCDDEEFF"
      "0000000430313233");

  std::string pssh;
  ASSERT_TRUE(absl::HexStringToBytes(pssh_str, &pssh));
  ...
  MediaInfo media_info = ConvertToMediaInfo(kMediaInfoWithContentProtection);
...
TEST_F(MpdUtilsTest, ContentProtectionPlayReadyCenc) {
  ...
  std::string pssh_hex_str;
  ASSERT_TRUE(absl::HexStringToBytes(pssh_str, &pssh_hex_str));
