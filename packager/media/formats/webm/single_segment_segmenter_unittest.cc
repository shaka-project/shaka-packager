...
const uint8_t kBasicSupportData[] = {
  ...
  // ID: Segment, Payload Size: 353
  0x18, 0x53, 0x80, 0x67, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x61,
    ...
    0x1c, 0x53, 0xbb, 0x6b, 0x8d,
      ...
      0xbb, 0x8b,
        ...
        0xb7, 0x86,
          ...
          0xf1, 0x81, 0xfd,
    // ID: Cluster, Payload Size: 88
    0x1f, 0x43, 0xb6, 0x75, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58,
      // Timecode: 0
      0xe7, 0x81, 0x00,
      ...
      // ID: BlockGroup, Payload Size: 33
      0xa0, 0xa1,
        // ID: Block, Payload Size: 9
        0xa1, 0x89, 0x81, 0x0b, 0xb8, 0x00, 0xde, 0xad, 0xbe, 0xef, 0x00,
        // ID: BlockAdditions, Payload Size: 19
        0x75, 0xa1, 0x93,
          // ID: BlockMore, Payload Size: 17
          0xa6, 0x91,
            // ID: BlockAddID, Payload Size: 8. This round-trips the value from
            // the input side_data (0x123456789a000000); previously a byte-order
            // bug truncated/byte-swapped it. See segmenter.cc.
            0xee, 0x88, 0x12, 0x34, 0x56, 0x78, 0x9a, 0x00, 0x00, 0x00,
