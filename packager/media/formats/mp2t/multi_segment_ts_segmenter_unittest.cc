...
class MultiSegmentTsSegmenterTest : public ::testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(MultiSegmentTsSegmenterTest, Initialize) {
  ...
  MultiSegmentTsSegmenter segmenter(options, nullptr);
...
TEST_F(MultiSegmentTsSegmenterTest, AddSample) {
  std::shared_ptr<VideoStreamInfo> stream_info(new VideoStreamInfo(
      kTrackId, kTimeScale, kDuration, kH264Codec,
      H26xStreamFormat::kAnnexbByteStream, kCodecString, kExtraData,
      arraysize(kExtraData), kWidth, kHeight, kPixelWidth, kPixelHeight,
...
TEST_F(MultiSegmentTsSegmenterTest, PassedSegmentDuration) {
  ...
  MultiSegmentTsSegmenter segmenter(options, &mock_listener);
...
TEST_F(MultiSegmentTsSegmenterTest, InitializeThenFinalize) {
  std::shared_ptr<VideoStreamInfo> stream_info(new VideoStreamInfo(
      kTrackId, kTimeScale, kDuration, kH264Codec,
      H26xStreamFormat::kAnnexbByteStream, kCodecString, kExtraData,
      arraysize(kExtraData), kWidth, kHeight, kPixelWidth, kPixelHeight,
...
// writer with a mock.
TEST_F(MultiSegmentTsSegmenterTest, FinalizeSegment) {
  std::shared_ptr<VideoStreamInfo> stream_info(new VideoStreamInfo(
      kTrackId, kTimeScale, kDuration, kH264Codec,
      H26xStreamFormat::kAnnexbByteStream, kCodecString, kExtraData,
      arraysize(kExtraData), kWidth, kHeight, kPixelWidth, kPixelHeight,
...
TEST_F(MultiSegmentTsSegmenterTest, EncryptedSample) {
  std::shared_ptr<VideoStreamInfo> stream_info(new VideoStreamInfo(
      kTrackId, kTimeScale, kDuration, kH264Codec,
      H26xStreamFormat::kAnnexbByteStream, kCodecString, kExtraData,
      arraysize(kExtraData), kWidth, kHeight, kPixelWidth, kPixelHeight,
