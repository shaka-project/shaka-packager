...
TEST(AC4AudioUtilTest, ChannelTest1) {
  ...
  const std::vector<uint8_t> ac4_data = {
      0x20, 0xa4, 0x02, 0x40, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xff,
      0xe0, 0x02, 0x12, 0xf8, 0x80, 0x00, 0x00, 0x42, 0x00, 0x00, 0x02,
      0x50, 0x10, 0x00, 0x00, 0x03, 0x10, 0x99, 0x5b, 0xa0, 0x40, 0x01,
      0x12, 0xf8, 0x80, 0x00, 0x00, 0x42, 0x00, 0x00, 0x02, 0x50, 0x10,
      0x00, 0x00, 0x03, 0x10, 0x99, 0x5b, 0x80, 0x40};
...
TEST(AC4AudioUtilTest, ChannelTest2) {
  // AC4 5.1-channel
  const std::vector<uint8_t> ac4_data = {
      0x20, 0xa6, 0x01, 0x60, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff,
      0xff, 0xe0, 0x01, 0x0e, 0xf9, 0x00, 0x00, 0x09, 0x00, 0x00,
...
TEST(AC4AudioUtilTest, ChannelTest3) {
  // AC4 stereo
  const std::vector<uint8_t> ac4_data = {
      0x20, 0xa4, 0x01, 0x40, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xff,
      0xe0, 0x01, 0x12, 0xf8, 0x00, 0x00, 0x08, 0x40, 0x00, 0x00, 0x4a,
      0x02, 0x00, 0x00, 0x00, 0x62, 0x13, 0x2b, 0x70, 0x00, 0x80};
...
TEST(AC4AudioUtilTest, ChannelTest4) {
  // AC4 CBI 5.1.2
  const std::vector<uint8_t> ac4_data = {
      0x20, 0xa0, 0x01, 0x60, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xff, 0xe0,
      0x01, 0x15, 0x13, 0x80, 0x00, 0x00, 0x58, 0x40, 0x00, 0x31, 0xfc, 0xa0,
      0x20, 0x00, 0x03, 0x1d, 0x40, 0x40, 0x00, 0x00, 0x08, 0x00, 0xc0};
